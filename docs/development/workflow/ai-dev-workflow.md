...
For product, UX, creative, game, platform, or greenfield browser-app work, the grooming record must
also capture the intended user or player, desired experience, primary loop or workflow, design
challenges, and the human question asked or why no human answer was needed.
