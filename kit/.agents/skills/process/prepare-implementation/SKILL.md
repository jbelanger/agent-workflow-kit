...
- For product, UX, creative, game, platform, or greenfield browser-app work: intended user or
  player, desired experience, primary loop or workflow, design challenges, and product judgment that
  remains human-owned.
...
# Human questions / design challenges
